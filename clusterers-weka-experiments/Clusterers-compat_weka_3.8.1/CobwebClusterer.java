...
public class CobwebClusterer /*implements ClusteringAlgorithm*/ {
	...
	private CobwebWithProgress clusterer;
	...
	public CobwebClusterer(ClusteringProgression clustProgress, double[][] rawData) {
...
//			return 0;
	...
	public ClusteringResult performClustering() {
		...
		/*HierarchicalClusterer*/ clusterer = new CobwebWithProgress();
...
//			DistanceFunction distanceFunction = new KMeansDistanceFunction();
...
//            clusterer.setInitializationMethod(new SelectedTag(SimpleKMeans.KMEANS_PLUS_PLUS, SimpleKMeans.TAGS_SELECTION));
	...
	public CobwebWithProgress getClusterer() {
		return clusterer;
	}

	class KMeansDistanceFunction extends ManhattanDistance /*implements DistanceFunction*/ {
