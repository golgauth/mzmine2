...
public class KMeansClusterer /*implements ClusteringAlgorithm*/ {
	...
	private SimpleKMeansWithProgress clusterer;
	...
	public KMeansClusterer(ClusteringProgression clustProgress, double[][] rawData) {
...
//			return 0;
	...
	public ClusteringResult performClustering() {
		...
		/*HierarchicalClusterer*/ clusterer = new SimpleKMeansWithProgress();
...
//            clusterer.setInitializationMethod(new SelectedTag(SimpleKMeans.CANOPY, SimpleKMeans.TAGS_SELECTION));
	...
	public SimpleKMeansWithProgress getClusterer() {
		return clusterer;
	}
