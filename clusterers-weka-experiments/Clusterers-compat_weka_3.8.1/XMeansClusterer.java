...
public class XMeansClusterer /*implements ClusteringAlgorithm*/ {

	private Logger logger = Logger.getLogger(this.getClass().getName());

	private static final String MODULE_NAME = "K-Means clusterer";

	private double[][] distMtx;
	Instances dataSet;

	private XMeansWithProgress clusterer;
	...
	public XMeansClusterer(ClusteringProgression clustProgress, double[][] rawData) {
...
//	}
	...
	public ClusteringResult performClustering() {
		...
		/*HierarchicalClusterer*/ clusterer = new XMeansWithProgress();
...
//		options[4] = "158";
		...
		String[] options = new String[] { "-output-debug-info", "-I", "158", "-L", "1", "-H", "158", "-C", "0.5" };//String.valueOf(1d / 1000d) };
		//String[] options = new String[] { "-output-debug-info", "-I", "1000", "-L", "10", "-H", "158", "-C", "0.5" };
...
//            clusterer.setInitializationMethod(new SelectedTag(SimpleKMeans.CANOPY, SimpleKMeans.TAGS_SELECTION));
	...
	public XMeansWithProgress getClusterer() {
		return clusterer;
	}
