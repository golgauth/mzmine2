...
public class DBSCANClusterer /*implements ClusteringAlgorithm*/ {
	...
	public DBSCANClusterer(ClusteringProgression clustProgress, double[][] rawData) {
...
//		return newDataset;
	...
	public ClusteringResult performClustering() {
		...
		/*HierarchicalClusterer*/ clusterer = new DBSCANWithProgress();
...
//						+ "OPTICSClusterer$CustomDistanceDataObject" };
	...
	public DBSCANWithProgress getClusterer() {
		return clusterer;
	}
