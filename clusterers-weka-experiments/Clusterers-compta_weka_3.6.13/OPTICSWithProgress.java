 ...
 */
public class OPTICSWithProgress 
    ...
    public void setDistanceMatrix(double[][] distMtx) {
     ...
     */
    public DataObject dataObjectForName(String database_distanceType, Instance instance, String key, Database database, double[][] distMtx) {
        Object o = null;
...
//            o = co.newInstance(new Object[]{instance, key, database});
            co = (Class.forName(database_distanceType)).
                    getConstructor(new Class[]{Instance.class, String.class, Database.class, Object.class});
            o = co.newInstance(new Object[]{instance, key, database, distMtx});
        } catch (NoSuchMethodException e) {
            e.printStackTrace();
        } catch (SecurityException e) {
            e.printStackTrace();
    ...
    public static void main(String[] args) {
        runClusterer(new OPTICSWithProgress(), args);
    }
