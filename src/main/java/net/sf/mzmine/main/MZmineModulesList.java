...
import net.sf.mzmine.modules.peaklistmethods.dataanalysis.kovatsri.KovatsRetentionIndexerModule;
...
import net.sf.mzmine.modules.peaklistmethods.identification.nistgc.NistMsSearchGCModule;
...
public class MZmineModulesList {
    ...
    public static final Class<?> MODULES[] = new Class<?>[] {
            ...
            JoinAlignerLcModule.class,
            JoinAlignerGcModule.class,
            ...
            // Data analysis
            // GLG:
            KovatsRetentionIndexerModule.class,
