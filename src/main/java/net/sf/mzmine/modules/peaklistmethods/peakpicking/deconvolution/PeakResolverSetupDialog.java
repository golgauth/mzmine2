        ...
        if (preview != null && preview.isSelected()) {
            ...
            if (previewRow != null) {
                ...
                if (parameterSet.checkParameterValues(new ArrayList<String>(0))) {
                    ...
                    // Peak resolver.
                    PeakResolver resolverModule = parameters
                            .getParameter(PEAK_RESOLVER).getValue().getModule();
                    try {
                        ...
                        resolvedPeaks = peakResolver.resolvePeaks(null,
                                previewPeak, scanNumbers, retentionTimes,
                                intensities, parameters);

                        // Turn off R instance.
                        if (resolverModule instanceof RbasedPeakResolver) {
                            ((RbasedPeakResolver) resolverModule).getRsession(
                                    null).close(false);
                        }
