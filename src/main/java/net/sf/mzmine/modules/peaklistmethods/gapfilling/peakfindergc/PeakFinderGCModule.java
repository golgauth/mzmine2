...
public class PeakFinderGCModule implements MZmineProcessingModule {

    private static final String MODULE_NAME = "Peak finder GC";
    ...
    public ExitCode runModule(@Nonnull MZmineProject project,
        ...
        PeakList[] peakLists = parameters
                .getParameter(PeakFinderGCParameters.peakLists).getValue()
                .getMatchingPeakLists();

        for (PeakList peakList : peakLists) {
            Task newTask = new PeakFinderGCTask(project, peakList, parameters);
            tasks.add(newTask);
        }
    ...
    public @Nonnull Class<? extends ParameterSet> getParameterSetClass() {
        return PeakFinderGCParameters.class;
    }
